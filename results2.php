...
<div class="row">
    ...
    <div class="col-md-11 col-md-offset-1 col-sm-12 col-sm-offset-1 col-xs-12 pull-left">
        ...
        <div class="row">
                                ...
                                if ($row['has_image'] == 1) {
                                    ...
                                    if (isset($_SESSION['u_id'])) {
                                        ...
                                        $fileResized = "img/resized_".$item_upc.".".$fileActualExt;
                                            ...
                                            <img id=resultPhoto src=$fileResized alt=$item_name onerror=this.src='img/noimageavailable.png' class='img-responsive' style='margin: 0 auto; min-width:260px; min-height:260px;'>
                                            </a>";
                                    //} else {
                                    ...
                                    if (isset($_SESSION['u_id'])) {
                                            echo "<a href=details.php?upc=".$item_upc.">
                                            <img id=resultPhoto src='$link' alt=$item_name onerror=this.src='img/noimageavailable.png' class='img-responsive' style='margin: 0 auto;'>
                                            </a>";
                                    } else {
                                        echo '<a href=details.php?upc='.$item_upc.'>
                ...
                <!-- <div class="onStep" data-animation="fadeInUp" data-time="900">
                    <div class="filter-wraper">
                        <ul id="filter-porto">
                            ...
                            <li class="filt-projects">PHOTOGRAPHY
                            </li>
                            <li class="space">
                            </li>
                            <li class="space">
                            ...
                            <li class="filt-projects active">ALL ALBUM
                            </li>
                        </ul>
                    </div>
                </div> -->
            ...
            <!-- right content -->
            <div class="col-md-3 pull-right" style="padding-left:10px; padding-right:15px;" id="mobile-sidebar">
