            ...
            <div class="no-gutter">
                ...
                <div class="col-md-12" style="">
                    <div class="onStep" data-animation="fadeInUp" data-time="200" style="margin-top:25px; background-color:#efefef;height:50px; border-top: 1px solid green;">
                        <div style="margin-bottom:15px !important;">
                            ...
                            <h5 class="center text-center" style='text-transform: uppercase; '>Popular Products You
                                Might Like! </h5>
                        </div>
                    </div>
                    <div id="owl-demo1" class="owl-carousel onStep" data-animation="fadeInLeftBig" data-time="200"
                              ...
                              echo "
                                              <div class='item ".$mylinkcss."'>
                                                    ...
                                                    //   $filename = "img/".$item_upc."*";
                                                      ...
                                                      echo "<img class='lazyOwl' data-src='".$file."' alt='".$item_name."' onerror=this.src='img/noimageavailable.png' style='margin:0 auto;'>";

                                                      } else {
                                                      //echo "<img style='' src='".$link."' alt='".$item_name."'>"; 
                                                      echo "<img class='lazyOwl' data-src='".$link."' alt='".$item_name."' onerror=this.src='img/noimageavailable.png' style='margin:0 auto;'>";
                                                      }
                ...
                <div class="col-md-12">
                    <div class="onStep" data-animation="fadeInUp" data-time="200" style="margin-top:25px; background-color:#efefef;height:50px; border-top: 1px solid green; text-align:center;">
                        <div style="margin-bottom:15px !important;">
                            <!-- spacer -->
                            <div class="space-half"></div>
                            <h5 style='text-transform: uppercase;' class="center"> Try Different Recipes! </h5>
                        </div>
                    </div>
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "
                                            <div class='item ".$mylinkcss."'> 
                                                    ...
                                                    echo "<img class='lazyOwl center-block' data-src='".$link."' alt='".$rname."' style=''>"; 
                ...
                <div class="col-md-12" style="padding:5px;">
                    <div class="onStep" data-animation="fadeInUp" data-time="200" style="margin-top:25px; background-color:#efefef;height:50px; border-top: 1px solid green;">
                        <!-- spacer -->
                        <!-- <div class="space-half"></div> -->
                        <h5 class="center" style=''  > My List Status 
                  ...
                  if (isset($_SESSION['u_id'])) {
                      ...
                      $sql = "SELECT * FROM grocery_lists INNER JOIN products ON grocery_lists.item_upc = products.item_upc WHERE grocery_lists.user_id = ".$uid." ORDER BY grocery_lists.item_name LIMIT 5";
                      $result = mysqli_query($conn, $sql);
                      $queryResults = mysqli_num_rows($result);
                      if ($queryResults > 0) {
                          $num = 0;
                          while ($row = mysqli_fetch_assoc($result)) 
                          {
                              ...
                              echo "
                                              <div class='item ".$mylinkcss."'>
                                                      ...
                                                      echo "<img class='lazyOwl center' data-src='".$file."' alt='".$item_name."' onerror=this.src='img/noimageavailable.png'>";

                                                      } else {
                                                      echo "<img class='lazyOwl center' data-src='".$link."' alt='".$item_name."' onerror=this.src='img/noimageavailable.png'>";
                                                      }
                                                      echo "<span class='owl-text center' style='margin-top:2px;line-height: 12px;margin-bottom:12px !important;'>".$item_name."</span>
                                                      </a>
                                                  </div>
                                              ";
                ...
                <div class="col-md-12" style="padding:5px;">
                    <div class="onStep" data-animation="fadeInUp" data-time="200" style="margin-top:25px; background-color:#efefef;height:50px; border-top: 1px solid green;">
                            <div style="margin-bottom:15px !important;">
                                <!-- spacer -->
                                <div class="space-half"></div>
                                <h5 style='text-transform: uppercase;' class="center"> My Recipes List </h5>
                            </div>
                    </div>
                    <div id="owl-demo3" class="owl-carousel onStep" data-animation="fadeInLeftBig" data-time="200" style="">
                    <?php 
                    ...
                    if ($queryResult > 0) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            echo "
                                            <div class='item ".$mylinkcss."'>
                                                    <a href='recipe_details.php?rid=".$rid."'>
                                                    <img class='lazyOwl center' data-src='".$link."' alt='".$rname."' style='margin:0 auto;' onerror='this.src=img/noimageavailable.png'></a> 
                                                    
                                                    <span class='owl-text center' style='margin-top:3px;line-height: 12px;'>".$rname."</span>
                                                    <span class='center' >
                                                    <a href='recipe_edit.php?rid=".$rid."' class='btn-sm btn-success center' style='color:#fff; display: inline-block;'>Edit</a>
