                ...
                <div class="row">
                    <div class="no-gutter">
                        ...
                        <div class="col-md-10 col-xs-12" style="">
                            ...
                            echo "
                                <div class='compareList' style='background-color:white !important;'>";
                            ...
                            ///////////////////STORE PRICE TOTALS AREA///////////////////////////////
                                        ...
                                        echo "
                                        <div class='storeTileArea' style='background-color:white !important;'>
                                        
                                            <ul id='storesListUL' style='background-color:white !important;'>";
                                        ...
                                        echo "
                                            <li style='background-color:white !important;'>
                                                <form action='my_list.php' method='get' name='store' class='store' id='store' style='background-color:white !important;'>
                                                    ...
                                                    <button type='submit' class='storeIdButton' value='".$storeId."'>
                                                        <label for='checkedStore".$n."'>
                                                            <div class='storePriceTile' "; 
                                                            if (isset($_GET['storeId']) && $_GET['storeId'] == $storeId) {
                                                                
                                                                echo " style='border: solid 3px #76BCE8;'";
                                                            } 
                            ...
                            /////////////////LIST AREA/////////////////////////////////
                            echo "<div class='cardArea' style='float:left;'>";
                                ...
                                echo "<div class='cardRow'>
                                    ...
                                    if (isset($_GET[' storeId'])) {
                                        ...
                                        <div class='product-container-thumbnail-myList'>
                                            <div id='product-photo-thumbnail' style='align:left;'>
                                        ...
                                        echo "<div class='stores'>
                                                <div class='gotIt'>
                                                    ...
                                                    $i++;
                                                    if (isset($_GET['storeId']) && $_GET['storeId'] == $storeId) {
                                                        echo "<strong>$".number_format($item_price*$item_qty, 2)."</strong>($$item_price/$measurement) They've got it!!";
                                                    }
                                            echo "  </h5>
                                                </div>
                                              </div>";
                                        ...
                                        echo "<div class='stores'>
                                            <div class='notGotIt'>
                                                <h5 style='height:25px;margin-top:4px;'>Nothing similar at ".urldecode($_GET['store']).".</h5>
                                            </div>
                                        </div>";
                                            $testArray[] = 0;
                                            $i++;
                            ...
                            ///////////////////END OF LIST AREA////////////////////////
                                ...
                                $storeId = $_GET['storeId'];
                                $store = $_GET['store'];
                                echo "<center><a href=shop.php?storeId=$storeId&storeName=".urlencode(trim($store))."><button class=finalize name=listReceived>Shop at ".urldecode($store)." >></button></a></center>";
                                }
