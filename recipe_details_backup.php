            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="no-gutter">
                        <!-- Left Area -->
                        <div class="col-md-10">
                            <div class="col-md-6 onStep" data-animation="fadeInLeft" data-time="0" style="background-color:#F8F7F5 !important; min-height: 600px !important;">
                            ...
                            <div class="col-md-6" style="">
                                <div class="onStep" data-animation="fadeInUp" data-time="300">
                                    ...
                                    if ($queryResult3 > 0) {
                                        ...
                                        echo "<button class='btn btn-rounded btn-main' rcreator='".$rcreator."' id='".$rcreator."' type='submit' style='width:90%; margin-top:10px; height:45px;margin-left: 50px; '>".$rcreator_name."<small class='badge'>(0 Recipes)</small></button>";
...
// -- Rating App -------------------------------
echo '
<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="z-index:99999 !important ;">
