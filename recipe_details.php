                ...
                <div class="row">
                    <div class="no-gutter">
                        ...
                        <div class="col-md-8 col-sm-12">
                            <div class="col-md-6 onStep" data-animation="fadeInLeft" data-time="0" style="">
                            ...
                            echo '
                                ...
                                <div id="gallery">
                                    <div id="panel" style="">';
                                        ...
                                        if ($row['haspic'] != "") {
                                            $pics = "img/recipes/".$row['haspic'];
                                        //$pics = '';
                                        } else {
                                            $pics = "img/noimageavailable.png";
                                        }

                            ?>

  
                                        <!--isset($row_lead['tsales']) ? $row_lead['tsales']:'0' -->
                                        ...
                                        <div id='carousel-custom' class='carousel slide img-responsive' data-ride='carousel' >
                                                ...
                                                <div class='carousel-inner'>
                                                    <div class='item active'>
                                                        ...
                                                        if ($row['hasvid']!="") { 
                                                            ...
                                                            echo "<img id='largeImage' src='".$pics."' alt='' class='img-responsive' />";
                                                        }
                                                        ?>
                                                        
                                                    </div>
                                                    <div class='item'>
                                                        <img class="center" src='<?php echo $pics; ?>' alt='' />
                                                    </div>              
                                            ...
                                            <!-- Indicators -->
                                            <ol class='carousel-indicators mCustomScrollbar img-responsive'>
                                            
                                            <?php 
                                            if ($row['hasvid'] != "") { 
                                                echo "<li data-target='#carousel-custom' data-slide-to='0' class='active img-responsive'><img id='recipe-photo-thumbnail' src='img/playback.png' alt='' /></li>";
                                            }

                                            if ( $row['haspic'] != "" && $row['hasvid'] != "") { 
                                                echo "<li data-target='#carousel-custom' data-slide-to='1' class='active img-responsive'><img id='recipe-photo-thumbnail' src='".$pics."' alt='' /></li>";
                                            } else {
                                                echo "<li data-target='#carousel-custom' data-slide-to='0' class='active img-responsive'><img id='recipe-photo-thumbnail' src='".$pics."' alt='' /></li>";
                                            }
                                            
                                            ?>
                                                <!-- <li data-target='#carousel-custom' data-slide-to='0' class='active'><img id="product-photo-thumbnail" src='<?php //echo $pics; ?>' alt='' /></li> -->
                                            
                                                <!-- <li data-target='#carousel-custom' data-slide-to='1'><img id="recipe-photo-thumbnail" src='<?//php echo $pics; ?>' alt='' /></li> -->
                                ...
                                <?php 
                                    echo '
                                        ...
                                        <div class="tab-content">
                                            ...
                                            echo"<button id='champakalibtn' type=submit class='btn btn-warning btn-lg btn-block' uid=".$uid." id=".$item_upc." style='width:51% !important;' onClick='clickmee(".$rid.", ".$uid.");'>Add To List</button>";
